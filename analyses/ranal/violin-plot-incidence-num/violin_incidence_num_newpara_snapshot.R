...
scenarios = list(
  repeat4times = list(
    fpath = fpaths.incidence.summary.newpara.repeat4times['snapshot'],
    # gpath = 'violin-plot-incidence-num/violin_incidence_num_newpara_snapshot_repeat4times.pdf'
    gpath = 'violin-plot-incidence-num//violin_incidence_num_newpara_snapshot_repeat4times-portrait.pdf'    
  ),
  repeat4times.tiff = list(
    fpath = fpaths.incidence.summary.newpara.repeat4times['snapshot'],
    # gpath = 'violin-plot-incidence-num/violin_incidence_num_newpara_snapshot_repeat4times.png'
    gpath = 'violin-plot-incidence-num/violin_incidence_num_newpara_snapshot_repeat4times-portrait.tiff'
  ),
  repeat4times.eps = list(
    fpath = fpaths.incidence.summary.newpara.repeat4times['snapshot'],
    # gpath = 'violin-plot-incidence-num/violin_incidence_num_newpara_snapshot_repeat4times.png'
    gpath = 'violin-plot-incidence-num/violin_incidence_num_newpara_snapshot_repeat4times-portrait.eps'
  )  
)
